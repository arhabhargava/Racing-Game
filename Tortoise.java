...
public class Tortoise extends Racer {
	...
	/**
	 * move: calculates the new x position for the racer Tortoise move
	 * characteristics: "slow & steady wins the race" increment x by 1 most of the
	 * time
	 */
	public void move() {
	...
	public void morph(Graphics g) {
		...
		// body
		g.fillOval(startX - 30, startY, 35, 25);
