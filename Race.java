...
public class Race extends JFrame {
	...
	private void prepareToRace() {
		...
		while (input != 's' && input != 'S') {
			...
			Elephant elephant = new Elephant("Elephant", START_LINE, yPos);
			Cat cat = new Cat("Cat", START_LINE, yPos);
	...
	private char getRacer() {
		String input = JOptionPane.showInputDialog(this, "Enter a racer:"
				+ "\nt for Tortoise, h for Hare, c for Cat or e for Elephant" + "\nor s to start the race");
		if (input == null) {
